...
export const SceneRenderer: React.FC<SceneRendererProps> = ({
  ...
  // ─── حساب Fade In للمشهد (أول 8 frames = ~0.27 ثانية) ──────────
  ...
  // ─── حساب Fade Out للمشهد (آخر 8 frames) ────────────────────────
  ...
  return (
    ...
    >
      ...
      {/* ─────────────────────────────────────────────────────────── */}
      {/* 🌑 2. Vignette (تعتيم الزوايا - اختياري)                   */}
      {/* ─────────────────────────────────────────────────────────── */}
      ...
      {/* ─────────────────────────────────────────────────────────── */}
      {/* 📺 3. Film Grain (حبيبات الفيلم - اختياري)                 */}
      {/* ─────────────────────────────────────────────────────────── */}
      {effects?.grade?.grain && (
        <FilmGrain
      ...
      {/* ─────────────────────────────────────────────────────────── */}
      {/* 🎯 4. Scene Type Indicator (للمشاهد الخاصة - اختياري)      */}
      {/* ─────────────────────────────────────────────────────────── */}
...
// ════════════════════════════════════════════════════════════════════
// ⚡ Hook Flash (وميض في بداية الـ hook)
// ════════════════════════════════════════════════════════════════════
const HookFlash: React.FC = () => {
  const frame = useCurrentFrame();

  // وميض أبيض في أول 5 frames
...
// ════════════════════════════════════════════════════════════════════
// ✨ CTA Glow (هالة ذهبية لمشهد call-to-action)
// ════════════════════════════════════════════════════════════════════
